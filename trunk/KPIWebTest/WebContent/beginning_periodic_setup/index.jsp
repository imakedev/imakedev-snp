...
$(document).ready(function() {
	...
	loadDynamicPage("assign_kpi");
	togle_page('assign_kpi','employee_link');
});
function loadDynamicPage(pageId){
	//pageId=_path+"beginnng_periodic_setup/load?page="+pageId;
	pageId=_path+"beginnng_periodic_setup/template/"+pageId+".jsp";
	//alert(pageId)
