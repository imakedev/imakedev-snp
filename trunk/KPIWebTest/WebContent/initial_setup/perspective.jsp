...
<body> 
 ...
 <div class="control-group">
    ...
    <div class="controls">
      <input class="input_snp" type="text"  id="perspectiveName"> <a class="btn btn-primary" onclick="searchPerSpective()"><i class="icon-search icon-white"></i>&nbsp;<span style="color: white;font-weight: bold;">Search</span></a>
    </div> 
  </div> 
</form> 
<div id="dialog-confirmDelete" title="Delete Perspective" style="display: none;background: ('images/ui-bg_highlight-soft_75_cccccc_1x100.png') repeat-x scroll 50% 50% rgb(204, 204, 204)">
	...
	KPIAjax.searchObject(query,{
		callback:function(data){
			var str="<div align=\"left\" style=\"padding-bottom: 4px\"> <a class=\"btn\" onclick=\"showForm('add','0')\"><i class=\"icon-plus-sign\"></i>&nbsp;<span style=\"font-weight: normal;\">Add</span></a></div>"+
			        ...
			        "   		<th width=\"82%\"><div class=\"th_class\">Perspective Name</div></th>"+ 
...
function doSubmitAction(){ 
	...
	var query="";
	if(mode=='add'){
			query="insert into "+SCHEMA_G+".perspective set perspective_name='"+perspectiveName+"', created_dt=now(),updated_dt=now()";
	}else {//edit
		  query="update  "+SCHEMA_G+".perspective set perspective_name='"+perspectiveName+"',updated_dt=now() where perspective_id="+perspectiveID; 
	}
