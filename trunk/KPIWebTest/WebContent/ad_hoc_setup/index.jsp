...
$(document).ready(function() {
	...
	loadDynamicPage("job_level");
	togle_page('job_level','employee_link');
});
function loadDynamicPage(pageId){
	//pageId=_path+"ad_hoc_setup/load?page="+pageId;
	pageId=_path+"ad_hoc_setup/template/"+pageId+".jsp";
              ...
              <div class="navbar-inner">
                <div class="container"> 
                  <div class="nav-collapse collapse navbar-responsive-collapse">
                    <ul class="nav">  
                      <li id="employee_link"><a onclick="togle_page('job_level','employee_link')">Job Level</a></li>
                    </ul>  
                  </div><!-- /.nav-collapse -->
                </div>
              </div><!-- /navbar-inner -->
