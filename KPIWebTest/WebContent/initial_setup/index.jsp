...
$(document).ready(function() {
	...
	loadDynamicPage("threshold");
	togle_page('threshold','employee_link');
});
function loadDynamicPage(pageId){
	//pageId=_path+"initial_setup/load?page="+pageId;
	pageId=_path+"initial_setup/template/"+pageId+".jsp";
	//alert(pageId)
